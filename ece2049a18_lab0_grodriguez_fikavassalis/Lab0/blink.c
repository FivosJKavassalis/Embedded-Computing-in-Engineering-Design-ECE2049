...
int main(void) {
	...
	while(1)   // forever loop 
	{
		...
		P6OUT = P6OUT ^ BIT2;		//Starts Blinking Red LED - Toggle P6.2 using exclusive-OR
		//P6OUT = P6OUT & ~BIT2;	// LED does not light up, so Logic 0 does not light up LED - Test whether logic logic 0 lights LED
		//P6OUT |= BIT2;		// LED stays on, meaning Logic 1 lights up the LED - or logic logic 1 lights LED
