...

{
    ...
    unsigned char names[14] = "Fivos and Gabe";
    ...
    uint8_t * pNames = (uint8_t *) names; // need casting since function Graphics_drawStringCentered() takes in a pointer of type uint8_t

    // Write some text to the display
    Graphics_drawStringCentered(&g_sContext, pNames, AUTO_STRING_LENGTH, 51, 48, TRANSPARENT_TEXT);


    // Draw a box around everything because it looks nice
    Graphics_Rectangle box = {.xMin = 3, .xMax = 92, .yMin = 5, .yMax = 91 };
