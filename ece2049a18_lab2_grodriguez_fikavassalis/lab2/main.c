...
void lightUpLedBuzz(int arrayVal);
        ...
        switch (state) {
            ...
            case 1:
            {
                ...
                for (i=0; i<46; i++) {
                    ...
                    currKey = getKey();
                    if(currKey == '#') { // CHANGED RESET BUTTON to #!!!
                        state=0;
                        currKey=0;
                    ...
                    while (timer_cnt < (timer_on + notes[i].duration)) { // notes[i].duration
                        ...
                        while (timer_cnt < (timer_on1 + notes[i].restFromPrevious)){
                               // DO NOTHING!
                        }
